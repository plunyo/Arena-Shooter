...
func disconnect_from_server(reason: String) -> void:
	...
	get_tree().change_scene_to_file("res://connect_screen/connect_screen.tscn")
...
func _on_poll_timer_timeout() -> void:
	...
	match status:
		...
		StreamPeerTCP.STATUS_NONE:
			disconnect_from_server("Unable to connect: server may not be running or network is unreachable.")
